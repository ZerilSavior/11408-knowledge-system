...
import * as M_features_code50_js from './features/code50.js';
...
const __NAMESPACES=[M_data_diagrams_js, M_data_syllabus_js, M_data_topic_content_js, M_core_store_js, M_core_cloud_js, M_core_util_js, M_core_md_render_js, M_core_ui_shell_js, M_features_study_loop_js, M_features_words_js, M_features_plan_js, M_features_reading_js, M_features_code50_js, M_features_exams_js, M_features_mindmap_js, M_features_notes_js, M_features_drawings_js, M_features_attach_js, M_features_maps_js, M_core_bootstrap_js, M_core_app_init_js];
